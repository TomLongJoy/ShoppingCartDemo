...
-(void)drawLineChartViewWithX_Value_Names:(NSMutableArray *)x_names TargetValues:(NSMutableArray *)targetValues LineType:(LineType) lineType{
    ...
    NSMutableArray *arrayOne = @[@10,@20,
                                 @30,@40,
                                 @50,@60,
                                 @70].mutableCopy;
    NSMutableArray *arrayTwo = @[@90,@80,
                                 @70,@60,
                                 @50,@40,
                                 @30].mutableCopy;
    NSMutableArray *arrayThree = @[@75,@65,
                                   @70,@80,
                                   @50,@30,
                                   @10].mutableCopy;
    NSArray *allArray = @[arrayOne,arrayTwo,arrayThree];
    NSArray *colorArray = @[UIColor.redColor,UIColor.greenColor,UIColor.blueColor,UIColor.cyanColor];
    for (NSInteger i = 0; i< allArray.count; i++) {
        NSMutableArray  *array = allArray[i];
